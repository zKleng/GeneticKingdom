...
SRC      = src/main/main.cpp src/map/Map.cpp src/game/Enemy.cpp src/game/TestEnemy.cpp src/game/Ogro.cpp src/game/ElfoOscuro.cpp src/game/Harpia.cpp src/game/Mercenario.cpp
OBJ_DIR  = obj
BIN_DIR  = bin
